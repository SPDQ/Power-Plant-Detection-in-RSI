...
def AddExtraLayers(net, use_batchnorm=True):
    ...
    # 20 x 20
    ResBody(net, last_layer, '6', out2a=256, out2b=256, out2c=1024, stride=2, kernel=2, use_branch1=True)
    # 10 x 10
    ResBody(net, 'res6', '7', out2a=256, out2b=256, out2c=1024, stride=2, kernel=2, use_branch1=True)
    # 5 x 5
    ResBody(net, 'res7', '8', out2a=256, out2b=256, out2c=1024, stride=1, kernel=3, use_branch1=True)
    # 3 x 3
    ResBody(net, 'res8', '9', out2a=256, out2b=256, out2c=1024, stride=1, kernel=3, use_branch1=True)
    # 1 x 1
    return net
...
output_result_dir = "./results/VOC2007/{}/Main".format(job_name)
