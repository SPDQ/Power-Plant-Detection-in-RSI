...
def parse_args(args):
    ...
    group.add_argument('--weights',           help='Initialize the model with weights from a file.', default='./keras-retinanet-0.5.0-resnet50_coco_best_v2.1.0.h5')
    ...
    parser.add_argument('--epochs',           help='Number of epochs to train.', type=int, default=1200)
    parser.add_argument('--steps',            help='Number of steps per epoch.', type=int, default=30)
