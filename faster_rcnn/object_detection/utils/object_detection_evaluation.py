...
#画recall和precision图
      i=str(class_index)
      #np.savetxt('/home/dq/models/research/object_detection/chimney/evaluation/recall'+i+'.txt',recall)
      #np.savetxt('/home/dq/models/research/object_detection/chimney/evaluation/precision'+i+'.txt',precision)
      l=[self.num_gt_instances_per_class[class_index]]
      np.savetxt('object_detection/chimney/evaluation/data/num_gt'+i+'.txt',l)
      #np.savetxt('/home/dq/models/research/object_detection/chimney/evaluation/tp_fp_labels'+i+'.txt',)
      #np.savetxt('/home/dq/models/research/object_detection/chimney/evaluation/scores'+i+'.txt',scores)
	  #print("recall",class_index,":",recall)
	  #print("precision",class_index,":",precision)
	  #print("num_gt",class_index,":",self.num_gt_instances_per_class[class_index])
	  #print("labels",class_index,":",tp_fp_labels)
