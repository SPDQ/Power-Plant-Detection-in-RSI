...
########################  
  #np.savetxt('object_detection/chimney/evaluation/data/classes'+tag+'.txt',detection_classes)
  #np.savetxt('object_detection/chimney/evaluation/data/scores'+tag+'.txt',detection_scores)
#######################3  
  if export_dir:
