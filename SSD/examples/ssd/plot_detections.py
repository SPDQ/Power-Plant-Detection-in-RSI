...
if __name__ == "__main__":
    ...
    parser.add_argument("--labelmap-file", default="/home/caffe/data/VOC0712/labelmap_voc.prototxt",
            help = "A file which contains the LabelMap.")
    parser.add_argument("--visualize-threshold", default=0.1, type=float,
            help = "Display detections with score higher than the threshold.")
    parser.add_argument("--save-dir", default="/home/caffe/results/pictures/",
